...
> 📦 **This fork ships ready-to-use binary releases** of the original [yandex/yags](https://github.com/yandex/yags) plugin (upstream is source-only).
...
This repository is a fork of [yandex/yags](https://github.com/yandex/yags) maintained by [Film XR](https://github.com/filmxr). The upstream repository publishes source code only; this fork additionally provides **prebuilt binary releases** for UE 5.5–5.7 and real-world virtual production examples. All plugin code © YANDEX LLC, licensed under the [Apache License 2.0](LICENSE).
